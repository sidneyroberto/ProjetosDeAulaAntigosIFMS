...
public class ReflectionUtil {
	 ...
	 * 
	 * @param obj
	 *            Objeto o qual se quer obter sua classe genérica.
	 * @param index
	 *            Índice da classe genérica do objeto.
	 ...
	 * 
	 * @param clazz
	 *            Classe a qual se quer obter sua classe genérica.
	 * @param index
	 *            Índice da classe genérica da classe consultada.
	 ...
	 * 
	 * @param clazz
	 *            Classe do método getter a ser retornado.
	 * @param fieldName
	 *            Nome do campo referente ao método getter.
	 ...
	 * 
	 * @param clazz
	 *            Classe do método setter a ser retornado.
	 * @param fieldName
	 *            Nome do campo referente ao método setter.
	 * @param paramTypes
	 *            Os tipos de parâmetros o qual o método setter recebe.
